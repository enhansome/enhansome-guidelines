...
* [C# Style Guide](https://github.com/kodecocodes/c-sharp-style-guide) ⭐ 500 | 🐛 3 | 📅 2023-02-03 - Community C# style guide.
...
* [The Clojure Style Guide](https://github.com/bbatsov/clojure-style-guide) ⭐ 4,099 | 🐛 46 | 📅 2026-04-15 - A community coding style guide for the Clojure programming language.
...
* [Emacs Lisp Style Guide](https://github.com/bbatsov/emacs-lisp-style-guide) ⭐ 1,134 | 🐛 16 | 📅 2026-03-31 - Community style guide for Emacs Lisp.
...
* [Go Standard Project Layout](https://github.com/golang-standards/project-layout) ⭐ 56,562 | 🐛 94 | 🌐 Makefile | 📅 2026-04-28 - Basic layout for Go applications.
* [Uber Go Style Guide](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 17,702 | 🐛 39 | 🌐 Makefile | 📅 2026-04-15 - Patterns and conventions used in Go code at Uber.
...
* [Airbnb JavaScript Style Guide](https://github.com/airbnb/javascript) ⭐ 148,202 | 🐛 163 | 🌐 JavaScript | 📅 2026-04-16 - A mostly reasonable approach to JavaScript.
* [JavaScript Clean Code](https://github.com/ryanmcdermott/clean-code-javascript) ⭐ 94,762 | 🐛 123 | 🌐 JavaScript | 📅 2024-07-29 - Software engineering principles, from Robert C. Martin's book [Clean Code](https://www.amazon.com/Clean-Code-Handbook-Software-Craftsmanship/dp/0132350882), adapted for JavaScript.
* [AngularJS Style Guide](https://github.com/mgechev/angularjs-style-guide) ⭐ 4,914 | 🐛 4 | 📅 2019-01-09 - Community-driven set of best practices for AngularJS application development.
...
* [Blue Style](https://github.com/JuliaDiff/BlueStyle) ⭐ 519 | 🐛 37 | 📅 2026-02-19 - Community style guide for Julia packages.
...
* [Google Markdown Style Guide](https://github.com/google/styleguide/blob/gh-pages/docguide/style.md) ⭐ 39,592 | 🐛 170 | 🌐 HTML | 📅 2026-09-11 - Style guide for Google-originated projects using Markdown.
...
* [Google Objective-C Style Guide](https://github.com/google/styleguide/blob/gh-pages/objcguide.md) ⭐ 39,592 | 🐛 170 | 🌐 HTML | 📅 2026-09-11 - Objective-C coding standards and conventions.
...
* [Clean Code PHP](https://github.com/piotrplenik/clean-code-php) ⭐ 12,445 | 🐛 30 | 🌐 PHP | 📅 2024-05-09 - Clean Code concepts adapted for PHP.
...
* [Ruby Style Guide](https://github.com/rubocop/ruby-style-guide) ⭐ 16,546 | 🐛 73 | 📅 2026-07-20 - A community-driven Ruby coding style guide.
* [Ruby Style Guide](https://github.com/airbnb/ruby) ⭐ 3,893 | 🐛 17 | 🌐 Ruby | 📅 2025-12-19 - Airbnb's Ruby Style Guide.
* [The Ruby Style Guide](https://rubystyle.guide) - A community-driven Ruby coding style guide.

### Rust

* [Rust Style Guide](https://github.com/rust-lang/rust/tree/HEAD/src/doc/style-guide/src) ⭐ 118,389 | 🐛 12,607 | 🌐 Rust | 📅 2026-09-11
* [Rust API Guidelines](https://rust-lang.github.io/api-guidelines/) - Guidelines for designing public Rust APIs.

### Scala

* [Scala Best Practices](https://github.com/alexandru/scala-best-practices) ⭐ 4,348 | 🐛 22 | 📅 2022-11-09 - Recommendations and patterns for Scala development.
...
* [Solcurity Standard](https://github.com/transmissions11/solcurity) ⭐ 2,179 | 🐛 3 | 📅 2023-07-02 - Security checklist and guidelines for Solidity smart contracts.
...
* [Swift style guide](https://github.com/kodecocodes/swift-style-guide) ⭐ 13,152 | 🐛 16 | 📅 2025-04-01 - Community Swift style guide.
...
* [Few Rules from Git Documentation](https://github.com/git/git/blob/master/Documentation/CodingGuidelines) ⭐ 63,109 | 🐛 388 | 🌐 C | 📅 2026-09-10 - Coding guidelines used in the Git project.
* [Git Style Guide](https://github.com/agis/git-style-guide) ⭐ 5,113 | 🐛 0 | 📅 2022-09-26 - Git usage and style recommendations.

### PowerShell

* [The PowerShell Best Practices and Style Guide](https://github.com/PoshCode/PowerShellPracticeAndStyle) ⭐ 2,432 | 🐛 38 | 📅 2023-05-19 - The Unofficial PowerShell Best Practices and Style Guide.

## Platforms

### Android

* [Android Guidelines](https://github.com/ribot/android-guidelines) ⭐ 4,995 | 🐛 12 | 📅 2021-07-10 - Architecture and code guidelines we use at ribot when developing for Android.
...
* [Microsoft REST API Guidelines](https://github.com/Microsoft/api-guidelines) ⭐ 23,331 | 🐛 178 | 📅 2026-08-05 - The Microsoft REST API Guidelines.
...
* [Front-End Checklist](https://github.com/thedaviddias/Front-End-Checklist) ⭐ 74,101 | 🐛 11 | 🌐 MDX | 📅 2026-08-14 - Pre-launch checklist for front-end projects.
* [Frontend Guidelines](https://github.com/bendc/frontend-guidelines) ⭐ 9,115 | 🐛 5 | 📅 2023-12-30 - Some HTML, CSS and JS best practices.
* [Airbnb CSS / Sass Styleguide](https://github.com/airbnb/css) ⭐ 6,970 | 🐛 23 | 📅 2024-06-04 - A mostly reasonable approach to CSS and Sass.
...
* [HTML Style Guide](https://github.com/marcobiedermann/html-style-guide) ⭐ 41 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-08 - A style guide which helps you write better, performant, structured, scalable and maintainable HTML.
...
* [Node.js Style Guide](https://github.com/felixge/node-style-guide) ⭐ 4,988 | 🐛 17 | 🌐 JavaScript | 📅 2021-01-24 - A guide for styling your Node.js / JavaScript code.
...
* [Project Guidelines](https://github.com/elsewhencode/project-guidelines) ⭐ 29,437 | 🐛 16 | 🌐 JavaScript | 📅 2024-12-09 - A set of best practices for JavaScript projects.
* [CodeQL Coding Standards](https://github.com/github/codeql-coding-standards) ⭐ 227 | 🐛 138 | 🌐 CodeQL | 📅 2026-09-10
...
* [ShellCheck](https://github.com/koalaman/shellcheck) ⭐ 40,024 | 🐛 1,139 | 🌐 Haskell | 📅 2026-08-04 - A shell script static analysis tool.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,034 | 🐛 404 | 🌐 JavaScript | 📅 2026-09-08 - Automated versioning and publishing from commits.
* [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,778 | 🐛 248 | 🌐 PHP | 📅 2024-04-01 - The tool for detecting and fixing the violations of the specified standards in PHP code.
* [Checkstyle](https://github.com/checkstyle/checkstyle) ⭐ 9,571 | 🐛 755 | 🌐 Java | 📅 2026-09-11 - Tool for checking Java source code for adherence to a Code Standard or set of validation rules.
* [Conventional Changelog](https://github.com/conventional-changelog/conventional-changelog) ⭐ 8,507 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-11 - Generate changelogs from Git commits.
* [EasyCodingStandard](https://github.com/easy-coding-standard/easy-coding-standard) ⭐ 1,624 | 🐛 0 | 🌐 PHP | 📅 2026-09-09 - The Easiest Way to Use Any Coding Standard.
